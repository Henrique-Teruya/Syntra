...
public class DemandasMateriais {
    private int id;
    ...
    public int getQuantidade_usada() { return quantidade_usada; }
    public void setQuantidade_usada(int quantidade_usada) { this.quantidade_usada = quantidade_usada; }
}
