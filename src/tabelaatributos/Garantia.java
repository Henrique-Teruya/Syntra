...
public class Garantia {
    ...
    private int id_demanda;        // NOVO: referencia demanda
    private int meses_garantia;
    private String data_compra;

    public int getId_garantia() { return id_garantia; }
    public void setId_garantia(int id_garantia) { this.id_garantia = id_garantia; }
    ...
    public int getMeses_garantia() { return meses_garantia; }
    public void setMeses_garantia(int meses_garantia) { this.meses_garantia = meses_garantia; }
